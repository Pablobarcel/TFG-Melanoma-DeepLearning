# src/models/cnn_triple/triple_model_planA_3class.py

import torch
import torch.nn as nn

# Importamos las 3 ramas expertas de 3 clases
...
class TripleModelPlanA3Class(nn.Module):
    def __init__(self, rgb_weights_path=None, arp_weights_path=None, meta_weights_path=None, meta_input_dim=11):
        super(TripleModelPlanA3Class, self).__init__()
        
        # --- RAMA 1: RGB (ResNet + ViT) ---
        self.rgb_branch = HybridViTCNN(num_classes_headB=3, pretrained=False)
        ...
        # --- 💉 INYECCIÓN DE CONOCIMIENTO MÚLTIPLE ---
        if rgb_weights_path:
        ...
        self.head_B = nn.Sequential(
            ...
            nn.GELU(),
            nn.Dropout(0.3),
            nn.Linear(512, 3) # 🚨 FIJADO A 3 CLASES
        )
    ...
    def forward(self, img_rgb, img_arp, features_meta):
        ...
        # 4. Concatenar las 3 Modalidades
