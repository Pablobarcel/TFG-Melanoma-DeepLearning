# src/models/cnn_triple/triple_model_planA_4class.py

import torch
import torch.nn as nn

# 🚨 Importamos las ramas expertas de 4 CLASES
...
class TripleModelPlanA4Class(nn.Module):
    def __init__(self, rgb_weights_path=None, arp_weights_path=None, meta_weights_path=None, meta_input_dim=11):
        super(TripleModelPlanA4Class, self).__init__()
        ...
        # --- FUSIÓN TOTAL (1280 dimensiones) ---
        self.total_features = self.rgb_feature_dim + self.arp_feature_dim + self.meta_feature_dim 
    ...
    def extract_arp_features(self, x):
        """Extraemos el embedding puro del ARP cortando el forward pass antes de las cabezas"""
